  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <!-- if using animation and transition together, set up type to show which length to use -->
        ...
        <transition
          ...
          leave-active-class="animate__animated animate__hinge animate__fast"
        >
          <div v-if="show" class="alert alert-info">This is some info</div>
        </transition>
        ...
        <transition
          ...
          :css="false"
        >
          <!-- :css="false" says that do not need to look for css -->
          <div
            v-if="load"
...
export default {
  ...
  methods: {
    ...
    enter(el, done) {
      ...
      //   need done() if there is no CSS code to tell when done
      //   done();
    },
    afterEnter(el) {
